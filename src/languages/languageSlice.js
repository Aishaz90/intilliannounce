...
const initialState = {
  ...
  translations: {
    en: {
      ...
      joinUsTitle: "You want join us <br /> and sell your products?",
      joinUsSubtitle: "Just 4 easy steps",
      createAccount: "Create your Account",
      chooseProduct: "Choose Product",
      fillForm: "Fill the form",
      postAnnounce: "Post Them",
      accountDesc: "create your account <br /> for free",
      productDesc: "choose any product <br /> you to sell",
      formDesc: "fill up the form for <br /> create an announce",
      postDesc: "And finally post your <br /> announce successfully",
